...
export default function HomePage({
  ...
  const handleCheckInChange = (value) => {
    ...
    setVillaCart((prev) => ({
      ...
      checkIn: value,
      checkOut:
        currentCheckOut && nextCheckIn && currentCheckOut > nextCheckIn
          ? prev.checkOut
          : '',
    }));
  };
  ...
  return (
    <main className="min-h-screen bg-[#F6EFE6] text-[#2A1A12] selection:bg-[#C15A3E] selection:text-white">
      <section id="booking" className="relative overflow-hidden bg-[#F6EFE6] pt-[86px] md:pt-[96px]">
        <div className="mx-auto max-w-[1440px] px-4 pb-10 md:px-8 lg:pb-16">
          <div className="grid grid-cols-1 gap-7 lg:grid-cols-[0.86fr_1.14fr] lg:items-center lg:gap-12">
            <div className="order-1">
              ...
              <div className="mt-6 grid max-w-xl grid-cols-2 gap-3 sm:grid-cols-4">
                {(theme.specs || []).slice(0, 4).map((spec) => (
                  ...
                  >
                    <div className="font-display text-3xl italic leading-none text-[#C15A3E] md:text-4xl">
                      {spec.value}
                    </div>

                    <div className="mt-2 text-[8px] font-bold uppercase tracking-[0.16em] text-[#2A1A12]/38 md:text-[9px]">
                      {spec.label}
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-6 grid grid-cols-1 gap-3 sm:max-w-xl sm:grid-cols-2">
                <button
                  type="button"
                  onClick={scrollToBookingPanel}
                  className="rounded-2xl bg-[#2A1A12] px-7 py-4 text-[11px] font-bold uppercase tracking-[0.22em] text-[#FFF9F2] transition hover:bg-[#C15A3E]"
                >
                  Check Availability
                </button>
            ...
            <div className="order-2">
              <div className="relative overflow-hidden rounded-[28px] bg-[#2A1A12] shadow-[0_24px_70px_rgba(42,26,18,0.18)] md:rounded-[32px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#2A1A12]/78 via-[#2A1A12]/10 to-transparent" />
          ...
          <div
            id="booking-panel"
            className="mt-7 rounded-[28px] border border-[#2A1A12]/10 bg-[#FFF9F2] p-4 shadow-[0_24px_70px_rgba(42,26,18,0.1)] md:p-6 lg:mt-10 lg:rounded-[32px]"
          >
      ...
      <section id="photos" className="bg-[#2A1A12] px-4 py-20 text-[#FFF9F2] md:px-8 md:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            {realGalleryImages.slice(0, 4).map((image, index) => (
              <div
                key={`${image}-${index}`}
                className={`overflow-hidden rounded-[30px] bg-white/5 ${
          ...
          <div className="overflow-hidden rounded-[30px] border border-[#2A1A12]/10 bg-[#FFF9F2] shadow-[0_24px_70px_rgba(42,26,18,0.08)]">
            ...
            <div className="grid grid-cols-7 gap-px bg-[#2A1A12]/10">
              {blanks.map((_, index) => (
                <div
                  key={`blank-${index}`}
                  className="min-h-[58px] bg-white p-1 md:min-h-[96px]"
                />
              ))}
              ...
              {days.map((day) => {
                ...
                const dateStr = `${currentYear}-${String(currentMonthIdx + 1).padStart(
                  2,
                  '0'
