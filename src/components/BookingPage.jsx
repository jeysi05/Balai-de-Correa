    ...
    <div>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-1 text-xs text-[#2A1A12]/50">
                {breakdown.packageNote} · {villaCart.guests || 2} guest
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-4 text-sm">
          <span className="text-[#2A1A12]/55">Base stay</span>

          <span className="font-semibold text-[#2A1A12]">{formatPHP(basePrice)}</span>
        </div>
          ...
          <div className="mb-6 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm font-light leading-7 text-[#2A1A12]/58 md:text-base md:leading-8">
                ...
                . Choose optional services below, then continue to manual payment instructions.
              </p>
            </div>
            ...
            <div className="rounded-[24px] border border-[#2A1A12]/10 bg-[#FFF9F2] p-5 md:min-w-[260px]">
              ...
              <div className="mt-2 text-xs leading-5 text-[#2A1A12]/45">
                Includes base stay, add-ons, and refundable security deposit.
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 grid grid-cols-3 gap-2 md:hidden">
            ...
            <div className="rounded-2xl border border-[#C15A3E]/20 bg-[#C15A3E]/[0.06] p-3">
              ...
              <div className="mt-1 truncate text-[11px] font-semibold leading-4 text-[#2A1A12]">
                {breakdown.packageName.replace(' Package', '')}
              </div>
            </div>
          </div>
